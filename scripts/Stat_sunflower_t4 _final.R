...
names(stat_t4)
gs_lmer_t4 <- lmer(gs_420~ Cumul_N*Sdt_DD +
                   (1 | plant),
                    data = stat_t4)
Anova(gs_lmer_t4)
...
AIC(gs_lmer_t4) # 58.208
vif(gs_lmer_t4) # no colinerarity
plot(resid(gs_lmer_t4) ~ fitted(gs_lmer_t4)) ## good
r.squaredGLMM(gs_lmer_t4) ## marginal : 0.17, conditional: 0.26
summary(gs_lmer_t4) 
...
hist(stat_t4$chi)
nrow(stat_t4)
chi_lmer_t4 <- lmer(chi~ Cumul_N*Sdt_DD +
                   (1|plant),
                 data = stat_t4)
plot(chi_lmer_t4)
...
Anova(chi_lmer_t4) ## N and DD effects 
AIC(chi_lmer_t4) # - 166.09
...
nrow(stat_t4)
betaleaf_lmer_t4 <- lmer(log(betaleaf)~ Cumul_N*Sdt_DD +
                      (1|plant),
                    data = stat_t4)
Anova(betaleaf_lmer_t4) ## drought effects 

plot(betaleaf_lmer_t4)
shapiro.test(residuals(betaleaf_lmer_t4)) # 0.44
outlierTest(betaleaf_lmer_t4)  ### No outliers
Anova(betaleaf_lmer_t4) ## N and DD effects 
AIC(betaleaf_lmer_t4) # - 166.09
...
summary(betaleaf_lmer_t4) # minimal variability in the intercepts and slopes across plants: variability in chi is likely being captured by the fixed effects 
qqnorm(residuals(betaleaf_lmer_t4))
...
Nmass_lmer_t4 <- lmer(log(Nmass)~ Cumul_N*Sdt_DD +
                   (1|plant),
                    data = stat_t4)
plot(Nmass_lmer_t4)
shapiro.test(residuals(Nmass_lmer_t4)) # 0.529
outlierTest(Nmass_lmer_t4)  ### No outliers
Anova(Nmass_lmer_t4) # N and DD effects
AIC(Nmass_lmer_t4) # 47.4
...
Nmass_plot_t4 <- ggplot(data = stat_t4, aes(x = Sdt_DD, y = Nmass)) + 
  ...
  ylab(expression(N[mass] ~ "(g" ~ N ~ g ~ leaf^{-1} ~ ")"))+
  xlab(expression (italic('Drought Severity Index')))
Nmass_plot_t4
#######################################################################################################################
...
Narea_lmer_t4 <- lmer(log(Narea)~ Cumul_N*Sdt_DD +
                    (1|plant),
                      data = stat_t4)
plot(Narea_lmer_t4)
...
Narea_plot_t4 <- ggplot(data = stat_t4, aes(x = Sdt_DD, y = Narea)) + 
  ...
  ylab(expression(N[area] ~ "(g" ~ N ~ m ~ leaf^{-2} ~ ")"))+
  xlab(expression (italic('Drought Severity Index')))
Narea_plot_t4
#######################################################################################################################
...
LMA_lmer_t4 <- lmer(log(LMA)~ Cumul_N*Sdt_DD +
                        (1|plant),
                      data = stat_t4)
plot(LMA_lmer_t4)
shapiro.test(residuals(LMA_lmer_t4)) # 0.65
outlierTest(LMA_lmer_t4)  ### No outliers
Anova(LMA_lmer_t4) # Only drought effects
AIC(LMA_lmer_t4) # - 18.08
vif(LMA_lmer_t4) # no colinerarity
plot(resid(LMA_lmer_t4) ~ fitted(LMA_lmer_t4)) ## good
r.squaredGLMM(LMA_lmer_t4) ## marginal : 0.28, conditional: 0.30
summary(LMA_lmer_t4) # minimal variability in the intercepts and slopes across plants: variability in chi is likely being captured by the fixed effects 
...
LMA_plot_t4 <- ggplot(data = stat_t4, aes(x = Sdt_DD, y = LMA)) + 
  ...
  ylab(expression(LMA ~ "(g" ~ leaf ~ m ~ leaf ^{-2} ~ ")")) +
  xlab(expression (italic('Drought Severity Index')))
LMA_plot_t4
#######################################################################################################################
####################### Vcmax #####################################################################################
hist(log(stat_t4$vcmax_tleaf))
Vcmax_lmer_t4 <- lmer(log(vcmax_tleaf)~ Cumul_N*Sdt_DD +
                      (1|plant),
                    data = stat_t4)
plot(Vcmax_lmer_t4)
...
Anova(Vcmax_lmer_t4) # N effect only
AIC(Vcmax_lmer_t4) #45.18
...
summary(Vcmax_lmer_t4) # minimal variability in the intercepts and slopes across plants: variability in chi is likely being captured by the fixed effects 
...
Jmax_lmer_t4 <- lmer(log(jmax_tleaf)~ Cumul_N*Sdt_DD +
                        (1|plant),
                      data = stat_t4)
...
Anova(Jmax_lmer_t4) # N effects only
AIC(Jmax_lmer_t4) #50.136
...
Anet_lmer_t4 <- lmer(log(anet_420)~ Cumul_N*Sdt_DD +
                       (1|plant),
                     data = stat_t4)
plot(Anet_lmer_t4)
...
Chl_lmer_t4 <- lmer(log(chl_mmolm2)~ Cumul_N*Sdt_DD +
                      (1|plant),
                    data = stat_t4)
plot(Chl_lmer_t4)
...
AIC(Chl_lmer_t4) # 62.61
vif(Chl_lmer_t4) # no colinerarity
plot(resid(Chl_lmer_t4) ~ fitted(Chl_lmer_t4)) ## good
r.squaredGLMM(Chl_lmer_t4) ## marginal : 0.48, conditional: 0.48
summary(Chl_lmer_t4) 
...
Nrubisco_lmer_t4 <- lmer(nrubisco~ Cumul_N*Sdt_DD +
                       (1|plant),
                     data = stat_t4)
plot(Nrubisco_lmer_t4)
shapiro.test(residuals(Nrubisco_lmer_t4)) # 0.37
outlierTest(Nrubisco_lmer_t4)  ### No outliers

Anova(Nrubisco_lmer_t4) # nothing 
AIC(Nrubisco_lmer_t4) #-8.76
vif(Nrubisco_lmer_t4) # no colinerarity
plot(resid(Nrubisco_lmer_t4) ~ fitted(Nrubisco_lmer_t4)) ## good
r.squaredGLMM(Nrubisco_lmer_t4) ## marginal : 0.017, conditional: 0.51
...
hist(stat_t4$nbioe)
Nbioe_lmer_t4 <- lmer(nbioe~ Cumul_N*Sdt_DD +
                           (1|plant),
                         data = stat_t4)
plot(Nbioe_lmer_t4)
shapiro.test(residuals(Nbioe_lmer_t4)) # 0.58
outlierTest(Nbioe_lmer_t4)  ### No outliers
Anova(Nbioe_lmer_t4) # nothing 
AIC(Nbioe_lmer_t4) #-158.87
vif(Nbioe_lmer_t4) # no colinerarity
plot(resid(Nbioe_lmer_t4) ~ fitted(Nbioe_lmer_t4)) ## good
r.squaredGLMM(Nbioe_lmer_t4) ## marginal : 0.1, conditional: 0.235
...
Nlh_lmer_t4 <- lmer(nlightharvesting~ Cumul_N*Sdt_DD +
                      (1|plant),
                    data = stat_t4)
plot(Nlh_lmer_t4)
shapiro.test(residuals(Nlh_lmer_t4)) # 0.75
outlierTest(Nlh_lmer_t4)  ### No outliers
Anova(Nlh_lmer_t4) # N effect only
AIC(Nlh_lmer_t4) # -212.64
vif(Nlh_lmer_t4) # no colinerarity
plot(resid(Nlh_lmer_t4) ~ fitted(Nlh_lmer_t4)) ## good
r.squaredGLMM(Nlh_lmer_t4) ## marginal : 0.22, conditional: 0.29
summary(Nlh_lmer_t4) 
...
Nstr_lmer_t4 <- lmer(log(Nstrucutre)~ Cumul_N*Sdt_DD +
                        (1|plant),
                      data = stat_t4)
plot(Nstr_lmer_t4)
shapiro.test(residuals(Nstr_lmer_t4)) # 0.767
outlierTest(Nstr_lmer_t4)  ### No outliers

Anova(Nstr_lmer_t4) # N and drought 
AIC(Nstr_lmer_t4) # 55.77
...
LUE_lmer_t4 <- lmer(log(LUE)~ Cumul_N*Sdt_DD +
                       (1|plant),
                     data = stat_t4_LUE)
Anova(LUE_lmer_t4) # N and drought effects, no interaction  
...
WUE_plot_t4 <- ggplot(data = stat_t4_LUE, aes(x = Sdt_DD, y = LUE)) + 
  ...
  ylab(expression(WUE[leaf] ~ (µmol ~ H[2]*O ~ µmol^{-1} ~ CO[2] ~ s^{-1}))) +
  xlab(expression (italic('Drought Severity Index')))
WUE_plot_t4

############################## PNUE ##################################################

PNUE_lmer_t4 <- lmer(log(PNUE)~ Cumul_N*Sdt_DD +
                       (1|plant),
                     data = stat_t4_PNUE)
Anova(PNUE_lmer_t4) # Nothing 
plot(PNUE_lmer_t4)
...
r.squaredGLMM(PNUE_lmer_t4) ## marginal : 0.07, conditional: 0.11
...
PSA_lmer_t4 <- lmer(log(plant_surface_area)~ Cumul_N*Sdt_DD +
                       (1|plant),
                     data = stat_t4)
plot(PSA_lmer_t4)
shapiro.test(residuals(PSA_lmer_t4)) # 0.067
outlierTest(PSA_lmer_t4)  ### 
Anova(PSA_lmer_t4) # N and drought*N effects
AIC(PSA_lmer_t4) # 54.55
...
Biomass_lmer_t4 <- lmer(log(biomass_all)~ Cumul_N*Sdt_DD +
                      (1|plant),
                    data = stat_t4)
plot(Biomass_lmer_t4)
shapiro.test(residuals(Biomass_lmer_t4)) # 0.087
outlierTest(Biomass_lmer_t4)  ### p = 0.62

Anova(Biomass_lmer_t4) # N and drought*N effects
AIC(Biomass_lmer_t4) # 81.094
vif(Biomass_lmer_t4) # no colinerarity
plot(resid(Biomass_lmer_t4) ~ fitted(Biomass_lmer_t4)) ## good
r.squaredGLMM(Biomass_lmer_t4) ## marginal : 0.189, conditional: 0.189
...
hist(stat_t4$RS_all)
RS_lmer_t4 <- lmer(RS_all~ Cumul_N*Sdt_DD +
                          (1|plant) + (1:block),
                        data = stat_t4)
plot(RS_lmer_t4)
outlierTest(RS_lmer_t4)
Anova(RS_lmer_t4) # Nothing 


######################## Cost transpiration ############################################

Cost_trans_roots_lmer_t4 <- lmer(Ecost~ Cumul_N*Sdt_DD +
                             (1|plant),
                           data = stat_t4)
plot(Cost_trans_roots_lmer_t4)
Anova(Cost_trans_roots_lmer_t4) # Nothing
summary(Cost_trans_roots_lmer_t4)
shapiro.test(residuals(Cost_trans_roots_lmer_t4)) 
outlierTest(Cost_trans_roots_lmer_t4)  ### p = 0.99
AIC(Cost_trans_roots_lmer_t4) # 80.004
vif(Cost_trans_roots_lmer_t4) # no colinerarity
plot(resid(Cost_trans_roots_lmer_t4) ~ fitted(Cost_trans_roots_lmer_t4)) ## good
r.squaredGLMM(Cost_trans_roots_lmer_t4) ## marginal : 0.05, conditional: 0.25
summary(Cost_trans_roots_lmer_t4) 
...
Cost_nitrogen_lmer_t4 <- lmer(Ncost ~ Cumul_N*Sdt_DD +
                             (1|plant),
                           data = stat_t4)
plot(Cost_nitrogen_lmer_t4)
Anova(Cost_nitrogen_lmer_t4) # N and interaction effects  
shapiro.test(residuals(Cost_nitrogen_lmer_t4)) # 0.25
outlierTest(Cost_nitrogen_lmer_t4)  ### 
AIC(Cost_nitrogen_lmer_t4) # 515.145
vif(Cost_nitrogen_lmer_t4) # no colinerarity
plot(resid(Cost_nitrogen_lmer_t4) ~ fitted(Biomass_lmer_t4)) ## good
r.squaredGLMM(Cost_nitrogen_lmer_t4) ## marginal : 0.238, conditional: 0.311
...
beta_lmer_t4 <- lmer(log(betaplant)~ Cumul_N*Sdt_DD +
                      (1|plant),
                    data = stat_t4)
Anova(beta_lmer_t4) # N effects and drought
summary(beta_lmer_t4) 

summary(beta_lmer_t4)
shapiro.test(residuals(beta_lmer_t4)) # 0.739
outlierTest(beta_lmer_t4)  ### p = 0.11691
AIC(beta_lmer_t4) # 80.004
vif(beta_lmer_t4) # no colinerarity
plot(resid(beta_lmer_t4) ~ fitted(beta_lmer_t4)) ## good
r.squaredGLMM(beta_lmer_t4) ## marginal : 0.189, conditional: 0.189
summary(beta_lmer_t4) 
...
ratio_J_V_lmer_t4 <- lmer(ratio_J_V~ Cumul_N*Sdt_DD +
                       (1|plant) + (1:block),
                     data = stat_t4)
plot(ratio_J_V_lmer_t4) # no outliers

Anova(ratio_J_V_lmer_t4) # Nothing 
...
names(stat_t4)
plot(stat_t4$transpiration,stat_t4$Narea)
stat_t4$trans_LAI = stat_t4$transpiration/stat_t4$plant_surface_area
LN = subset(stat_t4, n_trt == "LN")
HN = subset(stat_t4, n_trt == "HN")
nrow(HN)

sunflower_beta <- psem(
  lme2 <- lme(Ncost~ Sdt_DD + Cumul_N , data = stat_t4,random = ~1|plant),
  lme3 <- lme(Ecost~Sdt_DD, data = stat_t4,random = ~1|plant),
  lme8 <- lme(betaplant~Ncost + Ecost, data = stat_t4,random = ~1|plant),
  lme8 <- lme(betaleaf~betaplant + Sdt_DD + Cumul_N , data = stat_t4,random = ~1|plant),
  lme7 <- lme(chi~betaleaf, data = stat_t4,random = ~1|plant),
  lme8 <- lme(Narea~chi, data = stat_t4,random = ~1|plant), 
  lme8 <- lme(vcmax_tleaf~Narea, data = stat_t4,random = ~1|plant)
)
