...
Fig1a <- ggplot(data = B5, aes(x = DAD, y = FC, color = plant)) +
  geom_point(size = 3, alpha=0.5) +   # Add points with shapes for nitrogen levels
...
panel1_Fig4 <- rbind (Chi_plot_t4.g,betaleaf_plot_t4.g,Nmass_plot_t4.g,size="max")

Vcmax_plot_t4.g <- ggplotGrob(Vcmax_plot_t4)
LMA_plot_t4.g <- ggplotGrob(LMA_plot_t4)
Narea_plot_t4.g <- ggplotGrob(Narea_plot_t4)
panel2_Fig4 <- rbind (LMA_plot_t4.g, Narea_plot_t4.g,Vcmax_plot_t4.g, size="max")
...
grid.text("(a)", x = 0.02, y = 0.99, just = "left", gp = gpar(fontsize = 18, fontface = "bold"))
grid.text("(b)", x = 0.02, y = 0.67, just = "left", gp = gpar(fontsize = 18, fontface = "bold"))
grid.text("(c)", x = 0.02, y = 0.33, just = "left", gp = gpar(fontsize = 18, fontface = "bold"))

grid.text("(d)", x = 0.93, y = 0.99, just = "left", gp = gpar(fontsize = 18, fontface = "bold"))
grid.text("(e)", x = 0.93, y = 0.67, just = "left", gp = gpar(fontsize = 18, fontface = "bold"))
grid.text("(f)", x = 0.93, y = 0.33, just = "left", gp = gpar(fontsize = 18, fontface = "bold"))
...
Fig5 <- rbind (Anet_plot_t4.g, WUE_plot_t4.g,PNUE_plot_t4.g, size="max" )

jpeg(filename = "Fig5.png", 
     width = 10, height = 16, units = 'in', res = 1200)
grid.newpage()
grid.draw(Fig5)

grid.text("(a)", x = 0.93, y = 0.99, just = "left", gp = gpar(fontsize = 18, fontface = "bold"))
grid.text("(b)", x = 0.93, y = 0.67, just = "left", gp = gpar(fontsize = 18, fontface = "bold"))
grid.text("(c)", x = 0.93, y = 0.33, just = "left", gp = gpar(fontsize = 18, fontface = "bold"))
...
grid.text("(a)", x = 0.02, y = 0.98, just = "left", gp = gpar(fontsize = 18, fontface = "bold"))
grid.text("(b)", x = 0.93, y = 0.98, just = "left", gp = gpar(fontsize = 18, fontface = "bold"))
grid.text("(c)", x = 0.02, y = 0.48, just = "left", gp = gpar(fontsize = 18, fontface = "bold"))
grid.text("(d)", x = 0.93, y = 0.48, just = "left", gp = gpar(fontsize = 18, fontface = "bold"))
...
panel1_FigS3 <- rbind (Centered_Chi_plot.g, Centered_Betaleaf_plot.g,Centred_Nmass_plot.g, size="max")
...
panel2_FigS3 <- rbind (Centered_LMA_plot.g, Centred_Narea_plot.g,Centred_Vcmax_plot.g, size="max")
...
FigS4 <- rbind (Centered_Anet_plot.g, Centered_LWUE_plot.g,Centered_PNUE_plot.g, size="max")
